import tempfile
import traceback
from typing import Union, List, Dict, Tuple, Any, Protocol, Type, Optional, TypedDict
...
class AgentOrchestrator:
    ...
    def __init__(self, agents: List[Type[Agent]] = None):
        self.agents = agents or [ToolSelectionAgent, ToolExecutorAgent, PythonAgent, ValidationAgent, ResponseSynthesisAgent]
...
# Helper functions that are now outside of the agent classes
