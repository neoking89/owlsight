...
run with:
```bash
streamlit run examples/chatbot_example/main.py
```
"""
...
def chat_response(message, context=None, documents=None):
    ...
    #     response += "According to [1], the primary information related to your question is about document search functionality. "
    #     response += "[2] mentions additional details about semantic search capabilities. "
    #     if len(doc_names) > 2:
    #         response += "Furthermore, [3] provides insights about the user interface design."
    # else:
