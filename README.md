...
The following utility functions are available in the Python interpreter:

- `owl_import`: Import Python file to current namespace
- `owl_read`: Read text file content
- `owl_scrape`: Scrape webpage/Bing search result
- `owl_show`: Display active namespace objects
- `owl_write`: Write to text file
- `owl_history`: Display command history
- `owl_models`: Show loaded HuggingFace models
- `owl_press`: Press keys for automation
- `owl_save_namespace`: Save namespace to file
- `owl_load_namespace`: Load namespace from file
- `owl_tools`: Show available functions
- `owl_search`: Search and get results
